...
class Development extends CI_Controller {
	...
	{
		$this->create_department(array(1),'ITS','dep1');
		$this->create_department(array(1,2),'Linux Lab Technician','dep2');
		$this->create_department(array(2),'Pathways','dep3');
	}

	private function create_department($id,$name,$login_name)
	{
		$d = new Department();
		$d->name = $name;
